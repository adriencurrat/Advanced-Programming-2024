...
- **Object-Oriented Programming (OOP)** is central to the project’s structure, ensuring the code is organised and easy to maintain. Several classes are defined, each responsible for a distinct part of the application. **Encapsulation** groups related data and methods within these classes, while **Inheritance** allows classes to reuse code from parent classes. 
